define([ 'jquery', 'underscore', 'twigjs', 'lib/components/base/modal' ], function ($, _, Twig, Modal) {
  let CustomWidget = function () {
    ...
    this.datenSenden = function ( _this, exportData ) {
        ...
        {
          console.log( "open modal window" ); /* Debug */
        ...
        console.log( _this.datenSenden.counter ); // Debug
        ...
        /*
        console.log( 'startIndex:' ); // Debug
        console.log( startIndex ); // Debug

        console.log( 'endBorder:' ); // Debug
        console.log( endBorder ); // Debug
        */
        ...
        console.log( "exportDataPart after:" );
        console.log( exportDataPart );
        ...
        $.ajax(
            {
              ...
              error: function( jqXHR, textStatus, errorThrown  ) {
                ...
                //console.error( 'Ошибка времени исполнения виджета "Распределение ЛИДов"' );
                //console.error( jqXHR );
                ...
                success: function( Antwort, textStatus, xhr ) {
                    ...
                    console.log( "Serverantwort von app.php: " ); // Debug
                    console.log( Antwort ); // Debug
                    ...
                    switch ( xhr.status )
                    {
                        ...
                        default:
                          ...
                          else
                          {
                            ...
                            console.log( "progress " + _this.datenSenden.progress ); // Debug
    ...
    this.notice = function  ( header, text ) {
      ...
      console.log( 'Mitteilung vom Widget' ); // Debug
    ...
    this.callbacks = {
      ...
      render: function () {
        ...
        if ( self.system().area == "llist" )
        {
          ...
          for ( let user in self.users )
          {
            ...
            {
            self.usersList += '<p><input id="leadsDist_user" type="checkbox" data-id="' + user + '"> ' + self.users[user]["title"] + "</p>";

            self.usersListPercent += '\
                <div class = "percent_user">\
                <div data-id="' + user + '" class = "left">' + self.users[ user ][ "title" ] + '</div>\
        ...
        {
          console.log( self.name + " << render für advanced_settings" ); // Debug
      ...
      bind_actions: function () {
        ...
        console.log( self.name + " << bind_actions" ); // Debug

        if ( self.system().area == "llist" )
        {
          console.log( self.name + " << bind_actions für llist" ); // Debug
          ...
          $( ".ac-form-button" ).on( "click", function() {
              ...
              if ( $( "select#leadsDist_method" ).val() === "even" )
              {
                ...
                console.log( self.name + " << Выполнение распределения: even" ); // Debug
                ...
                console.log( "exportData before:" ); // Debug
                ...
                if ( Number( exportData.users.length ) )
                {
                  ...
                  console.log( "exportData after:" ); /* Debug */
                  console.log( exportData ); /* Debug */
              ...
              else if ( $( "select#leadsDist_method" ).val() === "percent" )
              {
                ...
                console.log( self.name + " << Выполнение распределения: percent" ); // Debug
                ...
                if ( Number( ProzentSumme ) === 100 )
                {
                  ...
                  console.log( "exportData befor:" ); // Debug
                  console.log( exportData ); // Debug
        ...
        if ( self.system().area == "advanced_settings" )
        {
          console.log( self.name + " << bind_actions für advanced_settings" );
          ...
          // button-input_blue
            ...
            $(".advanced_settings__button").on( "click", ".button-input_blue", () => {
                ...
                console.log( self.widgetSettings );
      ...
      settings: function () {
        ...
        //console.log( self.name + " << settings" ); // Debug
        ...
        $("div.widget-settings__command-plate").on( "click", "button.button-input.button-cancel.js-widget-uninstall", function() {
            ...
            console.log( self.name + " << off" ); // Debug
        ...
        if ( self.params.status === "not_configured" ) // FIXME anmelden nur nach der Speicherung die Benutzerdaten
        {
            ...
            $( 'input#leadsDist_privacyPolicy' ).change( function(){
                ...
                if ( $( this )[ 0 ].checked )
                {
                    console.log( 'leadsDist_privacyPolicy ist aktiviert' ); // Debug
                ...
                {
                    console.log( 'leadsDist_privacyPolicy ist deaktiviert' ); // Debug
            ...
            $( '.widget_settings_block__controls.widget_settings_block__controls_top' ).on( 'click', 'button.js-widget-save.button-input_blue', () => {
                ...
                else
                {
                    ...
                    console.log( 'Dieses Benutzerkonto wird angemeldet' ); // Debug
                    console.log( Ausfuhrdaten ); // Debug
      ...
      onSave: function () {
        ...
        console.log( self.name + " << onSave" ); // Debug
        return true;
      },

      destroy: function () {

        console.log( self.name + " << destroy" ); // Debug
        return true;
      },
      ...
      contacts: {
        ...
        selected: function () {
          console.log( self.name + " << contacts:" ); // Debug
        }
      },
      ...
      tasks: {
        ...
        selected: function () {
          //console.log( self.name + " << tasks:" ); // Debug
        }
      },

      advancedSettings: function () {

        console.log( self.name + " << advancedSettings" ); // Debug
        ...
        $.get(
            ...
            ( data, textStatus, xhr ) => {
                ...
                if ( self.widgetSettings )
                {
                  ...
                  console.log( self.widgetSettings ); // Debug
